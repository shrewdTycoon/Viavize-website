...
/* Who a strategy engagement is built for */
const audiences = ['Founders', 'Marketing leaders', 'Sales leaders']
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div {...fadeUp()}>
            ...
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-[1.15] mb-5">
              A plan, not a deck that sits on a shelf.
            </h2>

            <div className="w-12 h-[3px] rounded-full bg-turmeric mb-6" />

            <p className="text-[15px] text-slate leading-relaxed max-w-[440px] mb-8">
              One engagement takes you from an honest audit to a plan your team
              can execute &mdash; with the priorities, programs, and metrics all
              agreed up front.
            </p>
