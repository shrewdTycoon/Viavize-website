...
/* Markets where the technical depth matters — edit to match reality */
const markets = ['Security', 'Enterprise software', 'AI & data', 'Public sector', 'Manufacturing']

export default function ContentIncluded() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div {...fadeUp()}>
            ...
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-[1.15] mb-5">
              From the idea to the published piece.
            </h2>

            <div className="w-12 h-[3px] rounded-full bg-turmeric mb-6" />

            <p className="text-[15px] text-slate leading-relaxed max-w-[440px] mb-8">
              One engagement covers the research, the writing, and everything
              needed to get a piece live and working &mdash; without managing a
              freelancer, an editor, and a designer separately.
            </p>

            <span className="text-[11px] font-semibold uppercase tracking-[1.5px] text-muted mb-3 block">
              Markets we write for
            </span>
