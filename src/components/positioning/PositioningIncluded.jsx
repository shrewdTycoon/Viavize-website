...
/* Where the message shows up once it's set */
const surfaces = ['Website', 'Sales decks', 'Content', 'Email', 'Ads', 'Social']

export default function PositioningIncluded() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div {...fadeUp()}>
            ...
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-[1.15] mb-5">
              Everything to get the message right, and consistent.
            </h2>

            <div className="w-12 h-[3px] rounded-full bg-turmeric mb-6" />

            <p className="text-[15px] text-slate leading-relaxed max-w-[440px] mb-8">
              One engagement takes you from research to a message your whole
              team can use &mdash; the strategy, the words, and the work to put
              them into practice.
            </p>
