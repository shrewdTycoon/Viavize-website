...
const steps = [
  {
    ...
    desc: 'We look at your offering, your audience, how buyers evaluate you, and how competitors position themselves.',
    color: 'cyan',
  },
  {
    num: '02',
    title: 'Find the Sharp Edge',
    desc: 'We identify the specific, defensible position only you can credibly own — not the one everyone claims.',
    color: 'turmeric',
  },
  {
    num: '03',
    title: 'Build the Framework',
    desc: 'We write the positioning statement, message pillars, proof points, and the language to express them.',
    color: 'cyan',
  },
  {
    num: '04',
    title: 'Roll It Out',
    desc: 'We put the message into your site, sales material, content, and everywhere else your business speaks.',
    color: 'turmeric',
  },
]

export default function PositioningProcess() {
  return (
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        <motion.div {...fadeUp()} className="text-center mb-14">
          ...
          <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-tight">
            Understand the market.<br className="hidden md:block" /> Then find the words.
          </h2>
        </motion.div>
