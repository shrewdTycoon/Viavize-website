        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div {...fadeUp()}>
            ...
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-[1.15] mb-5">
              Everything a working website needs.
            </h2>

            {/* Accent underline */}
            <div className="w-12 h-[3px] rounded-full bg-turmeric mb-6" />

            <p className="text-[15px] text-slate leading-relaxed max-w-[440px]">
              One engagement covers the full path from message to live site —
              strategy, words, design, and code from a single connected team,
              with no handoffs between agencies.
            </p>
          </motion.div>
