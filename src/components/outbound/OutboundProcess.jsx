...
const steps = [
  {
    ...
    desc: 'We get specific about who is actually worth reaching, and what makes an account a real fit.',
    color: 'cyan',
  },
  {
    num: '02',
    title: 'Build the List & Message',
    desc: 'We source the accounts and contacts, and write messaging built for their problem, not ours.',
    color: 'turmeric',
  },
  {
    num: '03',
    title: 'Sequence & Send',
    desc: 'We set up multi-channel sequences, wired to your tools and set up to actually reach the inbox.',
    color: 'cyan',
  },
  {
    num: '04',
    title: 'Measure & Refine',
    desc: 'We track replies and meetings, and keep tightening the list and the message.',
    color: 'turmeric',
  },
]

export default function OutboundProcess() {
  return (
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        <motion.div {...fadeUp()} className="text-center mb-14">
          ...
          <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-tight">
            Get the list right.<br className="hidden md:block" /> Then earn the reply.
          </h2>
        </motion.div>
