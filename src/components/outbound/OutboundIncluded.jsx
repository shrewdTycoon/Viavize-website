...
/* Where outbound runs */
const channels = ['Email', 'LinkedIn', 'Phone', 'CRM']

export default function OutboundIncluded() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div {...fadeUp()}>
            ...
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-[1.15] mb-5">
              Everything to run outbound that gets replies.
            </h2>

            <div className="w-12 h-[3px] rounded-full bg-turmeric mb-6" />

            <p className="text-[15px] text-slate leading-relaxed max-w-[440px] mb-8">
              One engagement covers the list, the message, and the setup &mdash; so
              your outbound is built once, properly, instead of cobbled together
              between tools and freelancers.
            </p>
