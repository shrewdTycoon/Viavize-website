...
/* Where you get discovered */
const surfaces = ['Google', 'Bing', 'AI Overviews', 'ChatGPT', 'Perplexity', 'Maps']
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div {...fadeUp()}>
            ...
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-[1.15] mb-5">
              Everything to get found, and quoted.
            </h2>

            <div className="w-12 h-[3px] rounded-full bg-turmeric mb-6" />

            <p className="text-[15px] text-slate leading-relaxed max-w-[440px] mb-8">
              One engagement covers the technical, the content, and the structural
              work that improves how you rank in search and how often you are the
              source AI tools cite.
            </p>
