...
const steps = [
  {
    ...
    desc: 'We start with the decisions the data needs to inform, before building a single chart.',
    color: 'cyan',
  },
  {
    num: '02',
    title: 'Set Up Tracking',
    desc: 'We put the events, tags, and integrations in place that make the numbers reliable.',
    color: 'turmeric',
  },
  {
    num: '03',
    title: 'Build the Reporting',
    desc: 'We create dashboards and reports that answer the questions clearly, at a glance.',
    color: 'cyan',
  },
  {
    num: '04',
    title: 'Review & Act',
    desc: 'We turn the numbers into regular reads on what to continue, improve, or stop.',
    color: 'turmeric',
  },
]

export default function AnalyticsProcess() {
  return (
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        <motion.div {...fadeUp()} className="text-center mb-14">
          ...
          <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-tight">
            Start with the question.<br className="hidden md:block" /> End with the decision.
          </h2>
        </motion.div>
