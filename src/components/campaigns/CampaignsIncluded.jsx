...
/* Channels a campaign typically runs across */
const channels = ['Email', 'Paid media', 'Landing pages', 'Social', 'Content', 'Events']

export default function CampaignsIncluded() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div {...fadeUp()}>
            ...
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-[1.15] mb-5">
              Everything the campaign needs, in one place.
            </h2>

            <div className="w-12 h-[3px] rounded-full bg-turmeric mb-6" />

            <p className="text-[15px] text-slate leading-relaxed max-w-[440px] mb-8">
              One engagement covers the concept, the copy, the design, and the
              build across channels &mdash; coordinated by one team instead of
              stitched together from separate vendors.
            </p>

            <span className="text-[11px] font-semibold uppercase tracking-[1.5px] text-muted mb-3 block">
              Channels we run across
            </span>
