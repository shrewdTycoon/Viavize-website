...
const steps = [
  {
    ...
    desc: 'We start with the list: who is on it, where they came from, and what each group actually cares about. Segments come before subject lines.',
    color: 'cyan',
  },
  {
    num: '02',
    title: 'Message & Sequence',
    desc: 'We decide what to say, in what order, and how often — so a program builds an argument instead of repeating one.',
    color: 'turmeric',
  },
  {
    num: '03',
    title: 'Design & Build',
    desc: 'We write, design, and build the emails in your platform, with the automation, triggers, and tracking wired up behind them.',
    color: 'cyan',
  },
  {
    num: '04',
    title: 'Send, Measure, Improve',
    desc: 'We test subject lines, timing, and offers, then use what the response tells us to improve the next send.',
    color: 'turmeric',
  },
]
...
export default function HowWeRun() {
  return (
    <section id="how-we-run" className="py-24 md:py-32"
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        <motion.div {...fadeUp()} className="text-center mb-14">
          ...
          <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-tight">
            Audience first. Then message.<br className="hidden md:block" /> Then send.
          </h2>
        </motion.div>
