...
const steps = [
  {
    ...
    desc: 'We learn how deals actually progress, where they stall, and what reps are missing when they do.',
    color: 'cyan',
  },
  {
    num: '02',
    title: 'Build the Narrative',
    desc: 'We define the core story and messaging that every asset works from, so nothing contradicts.',
    color: 'turmeric',
  },
  {
    num: '03',
    title: 'Create the Kit',
    desc: 'We produce the decks, sheets, case studies, and templates reps will actually reach for.',
    color: 'cyan',
  },
  {
    num: '04',
    title: 'Enable & Improve',
    desc: 'We roll it out with the team and refine the material based on what is winning deals.',
    color: 'turmeric',
  },
]
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        <motion.div {...fadeUp()} className="text-center mb-14">
          ...
          <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-tight">
            Learn the sale.<br className="hidden md:block" /> Then build the kit.
          </h2>
        </motion.div>
