...
const steps = [
  {
    ...
    desc: 'We define the target metric and make sure it is actually measured before a dollar is spent.',
    color: 'cyan',
  },
  {
    num: '02',
    title: 'Strategy & Setup',
    desc: 'We choose the channels, audiences, budgets, and campaign structure built to hit that metric.',
    color: 'turmeric',
  },
  {
    num: '03',
    title: 'Launch & Optimize',
    desc: 'We go live, then test creative, audiences, and bids continuously to bring the cost down.',
    color: 'cyan',
  },
  {
    num: '04',
    title: 'Report & Scale',
    desc: 'We double down on what returns, cut what does not, and report the numbers straight.',
    color: 'turmeric',
  },
]
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        <motion.div {...fadeUp()} className="text-center mb-14">
          ...
          <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-tight">
            Measure first.<br className="hidden md:block" /> Then spend, and scale.
          </h2>
        </motion.div>
