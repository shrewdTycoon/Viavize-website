...
/* Platforms Viavize runs paid on — edit to match reality */
const platforms = ['Google Ads', 'LinkedIn', 'Meta', 'Microsoft', 'YouTube', 'Programmatic']

export default function PaidIncluded() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div {...fadeUp()}>
            ...
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-semibold text-navy leading-[1.15] mb-5">
              Everything from setup to the number that matters.
            </h2>

            <div className="w-12 h-[3px] rounded-full bg-turmeric mb-6" />

            <p className="text-[15px] text-slate leading-relaxed max-w-[440px] mb-8">
              One engagement covers strategy, tracking, creative, and ongoing
              management &mdash; so your paid program is run by one accountable team,
